...
DATASET_ID = "CanESM5_historical_r1i1p1f1_DBCCA_Daymet_TESSFA1"
...
def main():
    ...
    if (len(args) not in (3,5)) or (args and args[0] == '--help'):
        print("Example use: python TES_forcingGEN_NORTHCanESM5_historical_r1i1p1f1_DBCCA_Daymet_TESSFA1.py <input_path> <output_path> <time steps> [start_year end_year]")
